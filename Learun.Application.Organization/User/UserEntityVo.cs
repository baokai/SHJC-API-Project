...
namespace Learun.Application.Organization.User
{
    public class UserEntityVo
    {
        ...
        /// 多部门主键
        /// </summary>		
        [Column("F_MOREDEPARTMENTID")]
        public string F_MoreDepartmentId { get; set; }
        public string F_MoreDepartmentName { get; set; }
        /// <summary>
        /// 安全级别
        /// </summary>	
        ...
        /// 调岗
        /// </summary>		
        [Column("P_F_DepartmentId")]
        public string P_F_DepartmentId { get; set; }
        /// <summary>
        /// 合作伙伴标识
        /// </summary>
        [Column("F_HZ")]
        public string F_HZ { get; set; }
