    ...
    public class UserBLL : UserIBLL
    {
        ...
        public List<UserEntity> GetList(string companyId, string departmentId, string keyword)
        {
            try
            {
                ...
                {
                    list = list.FindAll(t => t.F_EnabledMark == 1 && t.F_DepartmentId.ContainsEx(departmentId));
                }
                if (!string.IsNullOrEmpty(keyword))
                {
                    list = list.FindAll(t => t.F_EnabledMark == 1 && t.F_RealName.ContainsEx(keyword) || t.F_Account.ContainsEx(keyword));
                }
                return list;
            }
            catch (Exception ex)
        ...
        /// <param name="userId">用户主键</param>
        /// <returns></returns>
        public UserEntity GetEntityByUserIdHZ(string userId)
        {
            try
            {
                UserEntity userEntity = cache.Read<UserEntity>(cacheKeyId + userId, CacheId.user);
                if (userEntity == null)
                {
                    userEntity = userService.GetEntityHZ(userId);
                    if (userEntity != null)
                    {
                        cache.Write<string>(cacheKeyAccount + userEntity.F_Account, userId, CacheId.user);
                        cache.Write<UserEntity>(cacheKeyId + userId, userEntity, CacheId.user);
        ...
        /// <returns></returns>
        public UserEntityVo GetHZUserId(string userId)
        {
            try
            {                     
                return userService.GetHZUserId(userId);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public UserEntityVo GetHZUserId_2(string userId)
        {
            try
            {
                return userService.GetHZUserId_2(userId);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public UserEntityVo GetHZUserName(string userId)
        {
            try
            {
                return userService.GetHZUserName(userId);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public DepartmentEntity GetDepartmentByUserId(string userId)
        {
            try
            {
                UserEntity userEntity = userService.GetEntity(userId);
                string deptId= userEntity.F_DepartmentId;
                DepartmentEntity departmentEntity = departmentIBLL.GetEntity(deptId);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public DepartmentEntity GetDepartmentNameList(string userId)
        {
            try
            {
                UserEntity userEntity = userService.GetEntity(userId);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public UserEntity GetFollowPersonNameByUserId(string userId)
        {
            try
            {
        ...
        /// <param name="userIds">用户主键串</param>
        /// <returns></returns>
        public List<UserEntity> GetListByUserIdsHZ(string userIds)
        {
            try
            {
                if (string.IsNullOrEmpty(userIds))
        ...
        public UserEntity GetAccountName(string Accoun)
        {
            try
            {
                return userService.GetAccountName(Accoun);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public UserEntityVo GetInspectorName(string name)
        {
            try
            {
                return userService.GetInspectorName(name);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveNewEntity(string keyValue, UserEntity userEntity)
        {
            try
            {
                ...
                cache.Remove(cacheKeyAccount + userEntity.F_Account, CacheId.user);
                cache.Remove(cacheKey + "dic", CacheId.user);
                userService.SaveNewEntity(keyValue, userEntity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntityList(string keyValue, string MDepartmentId)
        {
            try
            {
                ...
                userService.SaveEntityList(keyValue, MDepartmentId);
        ...
        public void ContractSubjectList(string keyValue, string F_ItemValue)
        {
            try
            {
                ...
                userService.ContractSubjectList(keyValue, F_ItemValue);
        ...
        public UserEntity CheckLoginFromJava(string account)
        {
            try
            {
                UserEntity userEntity = GetEntityByAccount(account);
        ...
        public void P_SaveForm(string[] dataList, string strEntity)
        {
            try
            {
                userService.P_SaveForm(dataList, strEntity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void P_HandOver(string strEntity)
        {
            try
            {
                userService.P_HandOver(strEntity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<UserEntity> GetListUser(string departmentId)
        {
            try
            {
                return userService.GetListUser(departmentId);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<DepartmentEntity> GetUserDepartmentId(string userId)
        {         
            try
            {
                UserEntity userEntity = userService.GetEntity(userId);
                string deptId = userEntity.F_DepartmentId; 
                 List<DepartmentEntity> depId = departmentIBLL.GetUserDepartmentId(deptId);
        ...
        public UserEntityVo DepartmentIdListById(string userId)
        {
            try
            {
                return userService.DepartmentIdListById(userId);
        ...
        public List<UserEntity> GetProduceUserList()
        {
            try
            {
                return userService.GetProduceUserList();
