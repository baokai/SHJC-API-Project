...
(function ($, learun) {
    ...
    $.lrselect = {
        ...
        defaultRender: function (dfop) {
            ...
            for (var i = 0, l = dfop.data.length; i < l; i++) {
                ...
                if (!item._lrhide) {
                    ...
                    var $li = $('<li data-value="' + i + '" class="lr-selectitem-li" >' + text + '</li>');
                    $ul.append($li);
                }
            ...
            for (var i = 0, l = dfop.data.length; i < l; i++) {
                ...
                if (!item._lrhide) {
                    if (!!dfop.multipleMapValue && dfop.multipleMapValue[i] != undefined) {
                        var $li = $('<li data-value="' + i + '" class="lr-selectitem-li" ><img class="lr-select-node-cb" src="' + top.$.rootUrl + '/Content/images/learuntree/checkbox_1.png">' + item[dfop.text] + '</li>');
                        $ul.append($li);
                    }
                    else {
                        var $li = $('<li data-value="' + i + '" class="lr-selectitem-li" ><img class="lr-select-node-cb" src="' + top.$.rootUrl + '/Content/images/learuntree/checkbox_0.png">' + item[dfop.text] + '</li>');
                        $ul.append($li);
                    }
                }
            }
        ...
        itemClick: function (e) {
            ...
            var $this = $('#' + dfop.id);
            if (dfop.type != 'multiple') {
                if ($et.parents('.lr-selectitem-li').length != 0) {
                    $et = $et.parents('.lr-selectitem-li');
                }
                ...
                if ($et.hasClass('lr-selectitem-li') || $et.hasClass('lr-select-node-cb')) {
                    ...
                    if (_index == -1) {
                        ...
                        $option.find('.lr-select-node-cb[src$="checkbox_1.png"]').attr('src', top.$.rootUrl + '/Content/images/learuntree/checkbox_0.png');
                        $option.slideUp(150);
                        $this.removeClass('lr-select-focus');
                    }
                    else {
                        ...
                        if (dfop.multipleMapValue[_index] == undefined) {
                            ...
                            $cbobj.attr('src', top.$.rootUrl + '/Content/images/learuntree/checkbox_1.png');
                        }
                        else {
                            dfop.multipleValue = [];
                            dfop.multipleText = [];
                            ...
                            selected = false;
                            $cbobj.attr('src', top.$.rootUrl + '/Content/images/learuntree/checkbox_0.png');
                        }
        ...
        defaultValue: function ($self, type) {
            ...
            if (dfop.type == 'multiple') {
                ...
                dfop.multipleValue = [];
                dfop.multipleText = [];
                $('#learun_select_option_' + dfop.id).find('.lr-select-node-cb').attr('src', top.$.rootUrl + '/Content/images/learuntree/checkbox_0.png');
            }
    ...
    $.fn.lrselect = function (op) {
        ...
        if (dfop.url) {
            if (dfop.isAsync) {
                ...
                learun.httpSync(dfop.method, dfop.url, dfop.param, function (data) {
                    $self[0]._lrselect.dfop.data = data || [];
                    $self[0]._lrselect.dfop.backdata = data || [];
                    dfop.isload = true;
                });
        ...
        function _fn(dfop) {
            if (dfop.isload == false) {
                ...
                switch (dfop.type) {
                    ...
                    case 'treemultiple':
                        $.lrselect.render(dfop);
                        $('#learun_select_option_' + dfop.id + " .lr-select-option-content").lrtreeSet('setCheck', value.split(','));
                        return false;
                    case 'gird':
                        break;
                    case 'multiple':
                        ...
                        dfop.multipleText = [];
                        if (dfop.isrender) {
                            $('#learun_select_option_' + dfop.id).find('.lr-select-node-cb[src$="checkbox_1.png"]').attr('src', top.$.rootUrl + '/Content/images/learuntree/checkbox_0.png');
                        }
                        ...
                        for (var i = 0, l = dfop.data.length; i < l; i++) {
                            ...
                            if (_arrayIndex != -1) {
                                ...
                                if (dfop.isrender) {
                                    $('#learun_select_option_' + dfop.id).find('[data-value="' + i + '"] .lr-select-node-cb').attr('src', top.$.rootUrl + '/Content/images/learuntree/checkbox_1.png');
                                }
                                if (dfop.select) {
