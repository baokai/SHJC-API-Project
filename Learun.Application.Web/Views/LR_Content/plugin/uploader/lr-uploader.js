/*
 * 版 本 Learun-ADMS V7.0.6 力软敏捷开 发 框架
...
(function ($, learun) {
    ...
    $.lrUploader = {
        ...
        openViewForm: function () {
            ...
            console.log(dfop)
            learun.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/Annexes/PreviewFileInfo?fileId=' + dfop.value, {}, function (data) {
                console.log(data)
             
                /*var url = "http://58.246.247.66:8012/onlinePreview?url=http://114.215.185.6:83/filePath" + data.F_FilePath.replace("C:/fileAnnexes", "");*/
                var url = "http://122.51.143.95:8012/onlinePreview?url=" + data.F_Url + filePath.replace("C:/fileAnnexes", "").replace("F:/fileAnnexes", "");
                window.open(url);
            });
            //learun.layerForm({
            //    id: 'PreviewForm',
