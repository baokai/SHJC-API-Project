/*
 * 版 本 Learun-ADMS V7.0.6 力软 敏捷 开发框架
                    ...
                    if (data) {
                        ...
                        switch (data.F_Type) {
                            ...
                            case 2:// 传阅
                                ...
                                break;
                            case 3:// 转交
                                learun.frameTab.open({ F_ModuleId: _taskId, F_Icon: 'fa magic', F_FullName: '转交审核-' + data.F_NodeName, F_UrlAddress: '/LR_NewWorkFlow/NWFProcess/NWFContainerForm?tabIframeId=' + _taskId + '&type=signAudit' + "&processId=" + data.F_ProcessId + "&taskId=" + _taskId });
                                break;
                            case 4:// 子流程
