...
namespace Learun.Application.Web.Areas.LR_AuthorizeModule.Controllers
{
    ...
    public class FilterTimeController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(FilterTimeEntity filterTimeEntity)
        {
            ...
            return Success("保存成功！", "时间过滤", string.IsNullOrEmpty("") ? OperationType.Create : OperationType.Update, "", filterTimeEntity.ToJson());
        }
        /// <summary>
        /// 删除过滤时段
        /// </summary>
        ...
        public ActionResult DeleteForm(string keyValue)
        {
            ...
            return Success("删除成功！", "时间过滤", OperationType.Delete, keyValue, keyValue);
        }
        #endregion
    }
}