...
namespace Learun.Application.Web.Areas.LR_AuthorizeModule.Controllers
{
    ...
    public class FilterIPController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string keyValue, FilterIPEntity filterIPEntity)
        {
            ...
            return Success("保存成功！", "IP过滤", string.IsNullOrEmpty(keyValue) ? OperationType.Create : OperationType.Update, keyValue, keyValue);
        }
        /// <summary>
        /// 删除过滤IP
        /// </summary>
        ...
        public ActionResult DeleteForm(string keyValue)
        {
            ...
            return Success("删除成功！", "IP过滤", OperationType.Delete, keyValue, keyValue);
        }
        #endregion
    }
}