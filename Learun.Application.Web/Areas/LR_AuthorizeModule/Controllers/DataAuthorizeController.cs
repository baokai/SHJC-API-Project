...
namespace Learun.Application.Web.Areas.LR_AuthorizeModule.Controllers
{
    ...
    public class DataAuthorizeController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string keyValue, string relation, string conditions)
        {
            ...
            return Success("保存成功！", "数据权限", string.IsNullOrEmpty(keyValue) ? OperationType.Create : OperationType.Update, relationEntity.F_Name, conditionEntityList.ToJson());
        }
        /// <summary>
        /// 删除表单数据
        /// </summary>
        ...
        public ActionResult DeleteForm(string keyValue)
        {
            ...
            return Success("删除成功！", "数据权限", OperationType.Delete, keyValue, keyValue);
        }
        #endregion
    }
}
