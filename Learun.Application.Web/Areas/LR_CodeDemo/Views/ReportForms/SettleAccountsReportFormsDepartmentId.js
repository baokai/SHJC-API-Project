var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        sum: function () {
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetSettleAccountsSumDepartmentId', { queryJson: JSON.stringify($.QueryJson)  }, function (data) {
        ...
        bind: function () {
          ...
          /*  $('#lr-sum').on('click', function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                //    }
                //});
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetSettleAccountsSumAllDepartmentId', { queryJson: JSON.stringify($.QueryJson)  }, function (data) {
                    var uuid = data.rows;
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetSettleAccountsDepartmentId',
                headData: [
