    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetMarketingsAlldc', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetMarketingsList',
                headData: [
        ...
        search: function (param) {
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetMarketingsSumdc', { queryJson: JSON.stringify(param) }, function (data) {
