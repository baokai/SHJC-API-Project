    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetProductionsDepartmentIdAll', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetProductionsDepartmentId',
                headData: [
        ...
        search: function (param) {
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetProductionsSumDepartmentId', { queryJson: JSON.stringify(param) }, function (data) {
