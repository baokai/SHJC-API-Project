    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetMarketingsAll', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetMarketings',
                headData: [
                    ...
                    {
                        label: "主部门", name: "MainDepartmentId", width: 80, align: "center",
                        formatterAsync: function (callback, value, row) {
                            learun.clientdata.getAsync('department', {
                                key: value,
                                callback: function (item) {
                        ...
                        name: "MainAmount", label: "主部门金额", width: 80, align: "left",
                        formatter: function (cellvalue) {
                            return learun.toDecimal(cellvalue);
                        }
                    },
                    {
                        label: "次部门", name: "SubDepartmentId", width: 80, align: "center",
                        formatterAsync: function (callback, value, row) {
                            learun.clientdata.getAsync('department', {
                                key: value,
                                callback: function (item) {
                        ...
                        name: "SubAmount", label: "次部门金额", width: 80, align: "left",
                        formatter: function (cellvalue) {
                            return learun.toDecimal(cellvalue);
                        }
                    },
        ...
        search: function (param) {
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetMarketingsSum', { queryJson: JSON.stringify(param) }, function (data) {
