var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        sum: function () {
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetSettleAccountsSumHZ', { queryJson: JSON.stringify($.QueryJson)  }, function (data) {
        ...
        bind: function () {
          ...
          /*  $('#lr-sum').on('click', function () {
            ...
            $('#lr_add').on('click', function () {
                var keyValue = $('#gridtable').jfGridValue('cProjectId');
                ...
                if (keyValue == null) {
                    ...
                    learun.layerForm({
                        id: 'form',
                        title: ProjectName+'比例添加',
                        url: top.$.rootUrl + '/LR_CodeDemo/ReportForms/SettleAccountsAddHZ?keyValue=' + keyValue,
                        width: 600,
                        height: 150,
            ...
            $('#lr-export').on('click', function () {
                ...
                //    }
                //});
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetSettleAccountsSumAllHZ', { queryJson: JSON.stringify($.QueryJson)  }, function (data) {
                    var uuid = data.rows;
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ReportForms/GetSettleAccountsHZ',
                headData: [
                    ...
                    {
                        label: "报备人", name: "PreparedPerson", width: 80, align: "left",
                    ...
                    {
                        name: "ProportionAmount", label: "结算金额", width: 80, align: "right",
                        formatter: function (cellvalue, row, op, $cell) {
                            
                            if (row.Proportion != null) {
                             
                                cellvalue = row.ContractAmount*row.Proportion
                                        return cellvalue
                    ...
                    {
                        label: "营销部门", name: "DepartmentIdCA", width: 70, align: "center",
                        formatterAsync: function (callback, value, row) {
