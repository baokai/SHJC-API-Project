    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectTask/GetPageListAllDepartmentId', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
                    learun.download({
                        method: "POST",
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    var taskStatus = $('#gridtable').jfGridValue('TaskStatus');
                    if (taskStatus != 1) {
                        learun.alert.error("当前报告已经再审核，请勿删除");
                        return;
                    }
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ProjectTask/GetPageListDepartmentId',
                headData: [
                    {
