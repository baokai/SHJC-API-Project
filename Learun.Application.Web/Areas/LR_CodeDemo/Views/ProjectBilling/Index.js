...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        sum: function () {
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectBilling/GetPageListAllSUM', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectBilling/GetPageListAll', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
                    learun.download({
                        method: "POST",
            ...
            $('#lr_add').on('click', function () {
                learun.layerForm({
                    id: 'form',
                    title: '开票申请新增',
                    url: top.$.rootUrl + '/LR_CodeDemo/ProjectBilling/Form',
                    width: 600,
                    height: 600,
                    callBack: function (id) {
                        var res = false;
                ...
                if (keyValue == null) {
                    ...
                    if (learun.checkrow(keyValue)) {
                        ...
                        learun.layerForm({
                            ...
                            url: top.$.rootUrl + '/LR_CodeDemo/ProjectBilling/Form?keyValue=' + keyValue + '&BillingStatus=' + BillingStatus,
                            width: 600,
                            height: 600,
                            callBack: function (id) {
