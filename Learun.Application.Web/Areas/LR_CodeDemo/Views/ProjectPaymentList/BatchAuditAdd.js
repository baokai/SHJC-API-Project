            ...
            $('#lr_agreList').on('click', function () {
                ...
                if (learun.checkrow(data)) {
                    learun.layerForm({
                        id: 'form',
                        title: '付款项目信息',
                        url: top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/IndexAdd?keyValue=' + data ,
                        width: 650,
                        height: 800,
                        maxmin: true,
                        btn: null,
                    ...
                    if (learun.checkrow(data)) {
                        learun.layerConfirm('是否批量添加？', function (res, _index) {
                            if (res) {
                                ...
                                $.lrSaveForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/SaveFormList?Ids=' + data, postData, function (res) {
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                ...
                headData: [
                    ...
                    { label: "合同编号", name: "ContractNo", width: 105, align: "center" },
