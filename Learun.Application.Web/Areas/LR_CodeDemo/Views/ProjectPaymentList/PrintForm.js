...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/GetPreviewFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    setFormData = function (processId, param, callback) {
        ...
        if (!!processId) {
            $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/GetFormDataByProcessIdPrint?processId=' + processId, function (data) {
    ...
    save = function (processId, callBack, i) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack(res, i);
            }
