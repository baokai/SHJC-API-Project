    ...
    var page = {
        ...
        bind: function () {
            ...
            $("#gridtable").dblclick(function () {
                        ...
                        if (learun.checkrow(keyValue)) {
                            learun.layerForm({
                                ...
                                url: top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/PreviewForm?keyValue=' + keyValue ,
                                width: 650,
                                height: 700,
            ...
            $('#lr_batchAudit').on('click', function () {
                ...
                learun.layerForm({
                    id: 'BatchAuditIndex',
                    title: '批量添加',
                    url: top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/BatchAuditAdd',
                    height: 700,
                    width: 920,
                    maxmin: true,
                    btn: null,
                ...
                if (keyValue == null) {
                    ...
                    if (learun.checkrow(keyValue)) {
                        learun.layerForm({
                            ...
                            url: top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/Form?keyValue=' + keyValue + "&ProjectId=" + projectId + "&PaymentStatus=" + paymentStatus,
                            width: 650,
                            height: 700,
                            callBack: function (id) {
            ...
            $('#lr_approve').on('click', function () {
                ...
                if (paymentStatus != 1) {
                    ...
                    if (paymentStatus == 11 && workFlowId != '') {
                        learun.httpAsync('POST', top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/UpdateFlowId', { keyValue: keyValue, ProcessId: workFlowId }, function (data) {
                            learun.httpAsync('Post', top.$.rootUrl + '/LR_NewWorkFlow/NWFProcess/AgainCreateFlow', { processId: workFlowId}, function (_data) {
                ...
                if (paymentStatus != 1) {
                    ...
                    if (learun.checkrow(keyValue)) {
                        learun.layerConfirm('是否确认删除该项！', function (res) {
                            if (res) {
                                learun.deleteForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/DeleteForm', { keyValue: keyValue }, function () {
                                    refreshGirdData();
                                });
                            }
                        });
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/GetPageListAll', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
                    learun.download({
                        method: "POST",
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ProjectPaymentList/GetPageList',
                headData: [
                    {
