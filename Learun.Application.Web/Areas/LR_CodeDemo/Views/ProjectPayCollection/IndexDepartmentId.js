    ...
    var page = {
        ...
        sum: function () {
           learun.loading(true);            
            ...
            learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectPayCollection/GetPageListSUMDepartmentId', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectPayCollection/GetPageListAllDepartmentId', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    // $("#AmountSUM").val(data.AmountSUM.toFixed(2));
                   var uuid = data.rows;
                    learun.download({
                        method: "POST",
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ProjectPayCollection/GetPageListDepartmentId',
                headData: [
                    {
