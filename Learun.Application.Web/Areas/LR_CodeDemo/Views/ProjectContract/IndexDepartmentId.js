    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr-export').on('click', function () {
                ...
                learun.httpAsync('Get', top.$.rootUrl + '/LR_CodeDemo/ProjectContract/GetPageListAllDepartmentId', { queryJson: JSON.stringify($.QueryJson) }, function (data) {
                    var uuid = data.rows;
                    learun.download({
                        method: "POST",
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/ProjectContract/GetPageListDepartmentId',
                headData: [
