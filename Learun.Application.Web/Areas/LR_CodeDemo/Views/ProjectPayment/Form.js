...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#ProjectId').lrformselect({
                ...
                //layerUrl: top.$.rootUrl + '/LR_CodeDemo/ProjectManage/GetSelectedProjectListTi',
                layerUrlW: 800,
                layerUrlH: 520,
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPayment/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    setFormData = function (processId, param, callback) {
        if (!!processId) {
            $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/ProjectPayment/GetFormDataByProcessId?processId=' + processId, function (data) {
