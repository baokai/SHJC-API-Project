...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/Payment/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    setFormData = function (processId, param, callback) {
        if (!!processId) {
            $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/Payment/GetFormDataByProcessId?processId=' + processId, function (data) {
               /* var projectId = data["Payment"].ProjectId;
                ...
                for (var id in data) {
                    ...
                    //if (data[id].PaymentStatus != 1 & data[id].PaymentStatus != 11) {
    ...
    save = function (processId, callBack, i) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/LR_CodeDemo/Payment/SaveForm?keyValue=' + keyValue, postData, function (res) {
