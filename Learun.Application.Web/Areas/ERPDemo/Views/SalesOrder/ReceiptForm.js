...
var bootstrap = function ($, learun) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strlR_ERP_SalesReceiptDetailList = JSON.stringify($('#LR_ERP_SalesOrderDetail').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/SalesReceipt/SaveForm', postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
