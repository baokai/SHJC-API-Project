...
var bootstrap = function ($, learun) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strlR_ERP_ProductInfoList = JSON.stringify($('#LR_ERP_ProductInfo').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/PurchaseRequisition/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
