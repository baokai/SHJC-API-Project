    ...
    var page = {
        ...
        initGird: function () {       
            $('#gridtable').lrAuthorizeJfGrid({
                ...
                //    $('#' + subid).jfGrid({
                //        url: top.$.rootUrl + '/ERPDemo/PurchaseRequisition/GetFormData?keyValue=' + $('#gridtable').jfGridValue('F_Id')+'',
                //        param: { code: 'LR_ERP_ProductInfo'},
                //        headData: [
                //            {
                ...
                //            },
                //            {
                //                label: '数量', name: 'F_Count', width: 100, align: 'left', statistics: true                         
                //            },
                //            {
                //                label: '单价', name: 'F_Price', width: 100, align: 'left', statistics: true                        
                //            },
                //            {
        ...
        initCharts: function (param) {
            param = "LR_ERP_PurchaseRequisition"; 
