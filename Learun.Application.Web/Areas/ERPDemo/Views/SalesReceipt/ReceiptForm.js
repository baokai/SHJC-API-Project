...
var bootstrap = function ($, learun) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strlR_ERP_ReceiptInfoDetailList = JSON.stringify($('#LR_ERP_SalesReceiptDetail').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/ReceiptInfo/SaveForm', postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
