...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#LR_ERP_PurchaseWarehousingDetail').jfGrid({
                headData: [
                    {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/ERPDemo/PurchaseWarehousing/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    acceptClick = function (callBack) {
        ...
        var postData = {};
        postData.strEntity = JSON.stringify($('[data-table="LR_ERP_PurchaseWarehousing"]').lrGetFormData());
        postData.strlR_ERP_PurchaseWarehousingDetailList = JSON.stringify($('#LR_ERP_PurchaseWarehousingDetail').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/PurchaseWarehousing/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
