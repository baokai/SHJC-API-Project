...
var bootstrap = function ($, learun) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strlR_ERP_PaymentInfoDetailList = JSON.stringify($('#LR_ERP_PurchaseWarehousingDetail').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/PaymentInfo/SaveForm', postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
