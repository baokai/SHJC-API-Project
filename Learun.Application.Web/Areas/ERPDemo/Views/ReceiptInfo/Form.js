...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#LR_ERP_ReceiptInfoDetail').jfGrid({
                headData: [
                    {
                        ...
                        ,edit:{
                            ...
                            change: function (data, rownum, selectData) {
                                ...
                                $('#LR_ERP_ReceiptInfoDetail').jfGridSet('updateRow', rownum);
                            },
                            op: {
                                width: 600,
                                height: 400,
                        ...
                        label: '单位', name: 'F_Unit', width:100, align: 'left'                    },
                    {
                        ...
                        , edit: {
                            ...
                            change: function (row, rownum) {
                                ...
                                $('#LR_ERP_PurchaseWarehousingDetail').jfGridSet('updateRow', rownum);
                            },
                        }
                    },
                    {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/ERPDemo/ReceiptInfo/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    acceptClick = function (callBack) {
        ...
        var postData = {};
        postData.strEntity = JSON.stringify($('[data-table="LR_ERP_ReceiptInfo"]').lrGetFormData());
        postData.strlR_ERP_ReceiptInfoDetailList = JSON.stringify($('#LR_ERP_ReceiptInfoDetail').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/ReceiptInfo/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
