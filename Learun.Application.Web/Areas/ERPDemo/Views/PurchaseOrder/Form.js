...
var bootstrap = function ($, learun) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strlR_ERP_PurchaseOrderDetailList = JSON.stringify($('#LR_ERP_PurchaseOrderDetail').jfGridGet('rowdatas'));
        $.lrSaveForm(top.$.rootUrl + '/ERPDemo/PurchaseOrder/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
