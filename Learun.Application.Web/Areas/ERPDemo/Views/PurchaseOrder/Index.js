    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                learun.layerForm({
                    id: 'form',
                    title: '新增采购订单',
                    url: top.$.rootUrl + '/ERPDemo/PurchaseOrder/Form',
                    width: 1200,
                    height: 700,
            ...
            $('#lr_edit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '编辑采购订单',
                        url: top.$.rootUrl + '/ERPDemo/PurchaseOrder/Form?keyValue=' + keyValue,
                        width: 1200,
                        height: 700,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/ERPDemo/PurchaseOrder/DeleteForm', { keyValue: keyValue}, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#lr_produced').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '生成采购入库单',
                        url: top.$.rootUrl + '/ERPDemo/PurchaseOrder/WareForm?keyValue=' + keyValue,
                        width: 1200,
                        height: 700,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_history').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '采购申请历史记录',
                        url: top.$.rootUrl + '/ERPDemo/PurchaseOrder/HistoryForm?&keyValue=' + keyValue,
                        width: 600,
                        height: 400,
                        btn: null
                    });
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/ERPDemo/PurchaseOrder/GetPageList',
                headData: [
