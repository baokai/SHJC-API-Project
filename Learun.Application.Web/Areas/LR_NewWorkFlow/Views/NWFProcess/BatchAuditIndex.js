...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            /////报告盖章
            $('#lr_agreetast').on('click', function () {
                var taskIds = $('#gridtable').jfGridValue('F_TaskId');
                if (learun.checkrow(taskIds)) {
                    learun.layerConfirm('是否审核报告盖章？', function (res, _index) {
                        if (res) {
                            ...
                            learun.httpAsync('Post', top.$.rootUrl + '/LR_NewWorkFlow/NWFProcess/AuditFlowstest', postData, function (data) {
