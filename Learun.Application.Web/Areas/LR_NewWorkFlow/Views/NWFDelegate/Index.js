    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                ...
                learun.layerForm({
                    id: 'Form',
                    title: '添加委托',
                    url: top.$.rootUrl + '/LR_NewWorkFlow/NWFDelegate/Form',
                    height: 600,
                    width: 800,
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/LR_NewWorkFlow/NWFDelegate/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
        ...
        initGrid: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/LR_NewWorkFlow/NWFDelegate/GetPageList',
                headData: [
