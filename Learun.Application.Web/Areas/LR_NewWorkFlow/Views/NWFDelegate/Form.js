...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            // 加载自定义流程列表
            learun.httpAsync('GET', top.$.rootUrl + '/LR_NewWorkFlow/NWFScheme/GetList', {}, function (data) {
                schemeList = data;
                render();
                isLoaded = true;
            });
        ...
        initData: function () {
            if (!!selectedRow) {
                ...
                learun.httpAsync('GET', top.$.rootUrl + '/LR_NewWorkFlow/NWFDelegate/GetRelationList', { keyValue: keyValue }, function (data) {
    ...
    acceptClick = function (callBack) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/LR_NewWorkFlow/NWFDelegate/SaveForm?keyValue=' + keyValue, { 'strEntity': JSON.stringify(formData), 'strSchemeInfo': String(schemeInfoList) }, function (res) {
            if (!!callBack) {
                callBack();
            }
        });
