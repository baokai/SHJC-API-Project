...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        renderSchema: function (schema) {
            ...
            isLoadTable = true;
            // 选中数据库
            $('#dbTree').lrtreeSet('setValue', schemaData.databaseLinkId);
            // 渲染表单
            var formScheme = {
        ...
        bind: function () {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        learun.httpAsyncPost(top.$.rootUrl + '/LR_CodeGeneratorModule/TemplatePC/LookWxCustmerCode', postData, function (res) {
                            if (res.code == 200) {
            ...
            $("#btn_save").on('click', function () {
                learun.layerForm({
                    id: 'codeform',
                    title: '保存模板',
                    url: top.$.rootUrl + '/LR_CodeGeneratorModule/CodeSchema/Form?F_Type=1',// 1.移动模板2.自定义模板3.工作流系统表单模板4.Excel风格模板5.报表模板
                    width: 600,
                    height: 400,
                    callBack: function (id) {
        ...
        save: function () {
            ...
            $.lrSaveForm(top.$.rootUrl + '/LR_CodeGeneratorModule/TemplatePC/CreateWxCustmerCode', postData, function (res) { }, true);
        },
        saveSchema: function () {
