    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#F_Proportion1').lrselect({
                placeholder: false,
                data: [{ id: '1', text: '1/1' }, { id: '2', text: '1/2' }]
            }).lrselectSet('1');
            ...
            $("#btn_finish").click(function () {
                ...
                $.lrSaveForm(top.$.rootUrl + '/LR_Desktop/DTChart/SaveForm?keyValue=' + keyValue, postData, function (res) {
