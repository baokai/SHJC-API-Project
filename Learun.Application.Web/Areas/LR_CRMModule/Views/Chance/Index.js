        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                ...
                learun.layerForm({
                    ...
                    cancel: function (id) {
                        return top[id].cancelClick(refreshGirdData);
                    }
                });
            });
            // 编辑
        ...
        initGrid: function () {
            $('#gridtable').jfGrid({
                ...
                headData: [
                    ...
                    { label: '商机阶段', name: 'F_StageId', width: 100, align: 'left', ishide: true },
                    ...
                    {
                        label: '预计金额', name: 'F_Amount', width: 100, statistics: true, align: 'left'
                    },
                    {
