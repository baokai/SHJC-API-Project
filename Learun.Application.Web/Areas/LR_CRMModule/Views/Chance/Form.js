    ...
    var page = {
        ...
        bind: function () {
           ...
           // $('#F_ChanceTypeId').lrDataItemSelect({ code: 'Client_ChanceSort', maxHeight: 230 });
            $('#F_EnCode').on('click', function () {
                $('#F_FullName').val($('#F_EnCode').val()).trigger('propertychange');
            });
            $('#F_ChanceTypeId').lrRadioCheckbox({
                type: 'radio',
                code: 'Client_ChanceSort'
            }); 
            // 商机来源
