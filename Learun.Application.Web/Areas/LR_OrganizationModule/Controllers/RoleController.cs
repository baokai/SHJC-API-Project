...
namespace Learun.Application.Web.Areas.LR_OrganizationModule.Controllers
{
    ...
    public class RoleController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string keyValue, RoleEntity entity)
        {
            ...
            return Success("保存成功！", "角色管理", string.IsNullOrEmpty(keyValue) ? OperationType.Create : OperationType.Update, entity.F_RoleId, entity.ToJson());
        }
        /// <summary>
        /// 删除表单数据
        /// </summary>
        ...
        public ActionResult DeleteForm(string keyValue)
        {
            ...
            return Success("删除成功！", "角色管理", OperationType.Delete, keyValue, "");
        }
        #endregion
    }
}