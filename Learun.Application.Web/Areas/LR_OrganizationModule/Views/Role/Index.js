...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            // 添加角色成员
            $('#lr_memberadds').on('click', function () {
                var keyValue = $('#gridtable').jfGridValue('F_RoleId');
                var loginInfo = learun.clientdata.get(['userinfo']);
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'SelectForms',
                        title: '添加角色成员',
                        url: top.$.rootUrl + '/LR_AuthorizeModule/UserRelation/SelectForms?objectId=' + keyValue + '&companyId=' + loginInfo.F_CompanyId + '&departmentId=' + loginInfo.F_DepartmentId + '&category=1',
                        width: 400,
                        height: 520,
                        callBack: function (id) {
                            return top[id].acceptClick();
            ...
            $('#lr_cdataauthorize').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        ...
                        url: top.$.rootUrl + '/LR_AuthorizeModule/DataAuthorize/CustomerFormIndex?objectId=' + keyValue + '&objectType=1',
                        width: 1100,
                        height: 700,
                        maxmin: true,
                        btn: null
