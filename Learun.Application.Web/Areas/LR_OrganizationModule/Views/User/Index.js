        ...
        bind: function () {
            ...
            $('#DepartmentId').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        title: '多部门添加',
                        url: top.$.rootUrl + '/LR_OrganizationModule/User/MoreDepartmentIdAdd?keyValue=' + keyValue,
                        width: 320,
                        height: 1050,
                        btn: null,
            ...
            $('#ContractSubject').on('click', function () {
                 var keyValue = $('#gridtable').jfGridValue('F_UserId');
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        title: '合同主体显示设置',
                        url: top.$.rootUrl + '/LR_OrganizationModule/User/DetailIndex?keyValue=' + keyValue,
                        width: 320,
                        height: 1050,
                        btn: null,
                        callBack: function (id) {
            ...
            //调岗
            $('#lr_post_mobilization').on('click', function () {
                var keyValue = $('#gridtable').jfGridValue('F_UserId');
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '调岗',
                        url: top.$.rootUrl + '/LR_OrganizationModule/User/Post_MobilizationForm?companyId=' + companyId,
                        width: 750,
                        height: 450,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
