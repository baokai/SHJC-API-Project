...
var bootstrap = function ($, learun) {
    ...
    function renderUserlist(list) {
        ...
        for (var i = 0, l = list.length; i < l; i++) {
            ...
            var _cardbox = "";
            _cardbox += '<div class="card-box ' + active + '" data-value="' + i
    ...
    function renderSelectedUserlist() {
        ...
        if (!!selectValue) {
            learun.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/User/GetEntityListByUserIdsHZ', { keyValue: selectValue }, function (data) {
                if (!!data) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            console.log("1234567890", loginInfo.companyId);
            // 部门
            $('#department_tree').lrtree({
                nodeClick: function (item) {
                    ...
                    if (!!userlist[item.id]) {
                        ...
                        learun.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/User/GetListHZ', { companyId: companyId, departmentId: departmentId }, function (data) {
            ...
            $('#department_tree').lrtreeSet('refresh', {
                url: top.$.rootUrl + '/LR_OrganizationModule/Department/GetTreeHZ',
                // 访问数据接口参数
            ...
            $("#txt_keyword").keydown(function (event) {
                if (event.keyCode == 13) {
                    ...
                    if (keyword != "") {
                        learun.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/User/GetListHZ', { companyId: companyId, keyword: keyword }, function (data) {
                            console.log(data);
                            renderUserlist(data || []);
                        });
                    }
