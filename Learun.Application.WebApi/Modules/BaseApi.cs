...
namespace Learun.Application.WebApi
{
    ...
    public class BaseApi : NancyModule
    {
        ...
        public Response Success(string info,string msg)
        {
            ResParameter res = new ResParameter { code = ResponseCode.success, info = msg, data = info };
            return Response.AsText(res.ToJson()).WithContentType("application/json");
        }
        /// <summary>
        /// 成功响应数据
        ...
        private Response BeforeRequest(NancyContext ctx)
        {
            ...
            if (path == "/learun/adms/user/login" || path == "/learun/adms/user/loginByUserCode" || path == "/" || path == "/index.html" 
                || path == "/bgimg" || path == "/learun/adms/user/img" || path == "/learun/adms/desktop/img" 
                || path == "/learun/adms/annexes/down" || path == "/learun/adms/LR_CodeDemo/Project/getMarketings" 
                || path == "/learun/adms/LR_CodeDemo/Project/getMarkeTingList")


                if (path == "/learun/adms/user/login" || path == "/"
                    || path == "/index.html" || path == "/bgimg"
                    || path == "/learun/adms/user/img"
                    || path == "/learun/adms/desktop/img"
                    || path == "/learun/adms/annexes/down"
                    || path == "/learun/adms/LR_CodeDemo/Project/getTableList" ||
                    path == "/learun/adms/user/loginByUserCode" ||
                    path == "/learun/adms/LR_CodeDemo/Project/getProjectMonthCount" ||
                    path == "/learun/adms/LR_CodeDemo/Project/getProjectCountBySource" ||
                         path == "/learun/adms/LR_CodeDemo/Project/getProjectCountByProvince" ||
                         path == "/learun/adms/LR_CodeDemo/Project/getProjectConversion" ||
                         path == "/learun/adms/LR_CodeDemo/Project/getBackProjectRate")
            ...
            {
                WebHelper.AddHttpItems("currentUrl", path);
            }
            else
            {
                WebHelper.UpdateHttpItem("currentUrl", path);
            }
            ...
            {
                // 判断当前接口是否需要加载数据权限
                if (!this.DataAuthorize(path))
                {
                    return this.FailNoLogin("没有该数据权限");
