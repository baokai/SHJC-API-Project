...
namespace Learun.DataBase.Repository
{
    ...
    public class Repository : IRepository
    {
        ...
        /// <param name="strSql">sql语句</param>
        /// <returns></returns>
        public IEnumerable<T> FindList_Export<T>(string strSql, out string sql) where T : class
        {
            if (dbWhere != null)
            {
                int orderIndex = strSql.ToUpper().IndexOf("ORDER BY");
        ...
        /// <summary>
        /// 查询列表根据sql语句 没有dbWhere
        /// </summary>
        /// <typeparam name="T">类型</typeparam>
        /// <param name="strSql">sql语句</param>
        /// <returns></returns>
        public IEnumerable<T> FindList_NodbWhere<T>(string strSql) where T : class
        {
            return db.FindList<T>(strSql);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public IEnumerable<T> FindList_NodbWhere<T>(string strSql, Pagination pagination) where T : class
        {
