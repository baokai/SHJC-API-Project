...
namespace Learun.DataBase.Repository
{
    ...
    public interface IRepository
    {
        ...
        IEnumerable<T> FindList_NodbWhere<T>(string strSql) where T : class;
        IEnumerable<T> FindList_NodbWhere<T>(string strSql, Pagination pagination) where T : class;
        IEnumerable<T> FindList_Export<T>(string strSql, out string sql) where T : class;
