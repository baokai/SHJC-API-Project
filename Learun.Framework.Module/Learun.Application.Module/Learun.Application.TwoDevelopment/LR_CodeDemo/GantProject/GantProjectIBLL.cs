...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    public interface GantProjectIBLL
    {
        ...
        IEnumerable<LeaderboardVo> GetContractAmountLeaderboard(string queryJson);
        IEnumerable<LeaderboardVo> GetTaskFinishedRateLeaderboard(string queryJson);
        IEnumerable<LeaderboardVo> GetCollectionAmountLeaderboard(string queryJson);
        /// <summary>
        /// 获取项目明细列表
        /// </summary>
