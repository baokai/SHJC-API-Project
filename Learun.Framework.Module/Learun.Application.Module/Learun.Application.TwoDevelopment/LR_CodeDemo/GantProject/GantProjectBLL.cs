...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    public class GantProjectBLL : GantProjectIBLL
    {
        ...
        {
            return gantProjectService.GetContractAmountLeaderboard(queryJson);
        }
        public IEnumerable<LeaderboardVo> GetTaskFinishedRateLeaderboard(string queryJson)
        {
            return gantProjectService.GetTaskFinishedRateLeaderboard(queryJson);
        }
        public IEnumerable<LeaderboardVo> GetCollectionAmountLeaderboard(string queryJson)
        {
            return gantProjectService.GetCollectionAmountLeaderboard(queryJson);
        }
        /// <summary>
        /// 获取项目列表
        /// </summary>
