...
namespace Learun.Application.Base.CodeGeneratorModule
{
    ...
    public class CodeGenerator
    {
        ...
        private string NotesCreate(CodeBaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 Learun-ADMS V7.0.6 力软敏捷开发框架\r\n");
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                // 添加数据库配置
                string dbname = "";
                if (baseConfigModel.databaseLinkId != "systemdb")
                {
                ...
                sb.Append("        /// 获取列表数据\r\n");
                sb.Append("        /// </summary>\r\n");
                sb.Append("        /// <param name=\"queryJson\">条件参数</param>\r\n");
                sb.Append("        /// <returns></returns>\r\n");
        ...
        public string ServiceCreate(string databaseLinkId, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData, BaseModel baseInfo)
        {
            try
            {
                ...
                foreach (var tableOne in dbTableList)
                {
                    ...
                    {
                        if (baseInfo.pkType == "string")
                        {
                            content += "                return this.BaseRepository(" + dbname + ").FindEntity<" + tableOne.name + "Entity>(keyValue);\r\n";
                        }
                        else {
                            content += "                return this.BaseRepository(" + dbname + ").FindEntity<" + tableOne.name + "Entity>(keyValue.ToInt());\r\n";
                        }
                    }
                    else
                    {
                ...
                sb.Append("        /// </summary>\r\n");
                sb.Append("        /// <param name=\"keyValue\">主键</param>\r\n");
                sb.Append("        public void DeleteEntity(" + baseInfo.pkType + " keyValue)\r\n");
                content = "";
                ...
                // 函数传入参数
                string paramStr = baseInfo.pkType + " keyValue, " + mainTable + "Entity entity,";
                foreach (var tableOne in dbTableList)
                {
        ...
        public string GridEditServiceCreate(string databaseLinkId, string dbTable, string dbTablePk, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData, BaseModel baseInfo)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(colData.treefieldRe))
                {
                    //tree
                }
                ...
                sb.Append("        public void SaveEntity(" + baseInfo.pkType + " keyValue, " + dbTable + "Entity entity)\r\n");
                content = "";
                if (baseInfo.pkType == "string")
                {
                    content += "                if (!string.IsNullOrEmpty(keyValue))\r\n";
        ...
        public string IBllCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("        /// </summary>\r\n");
                sb.Append("        /// <param name=\"keyValue\">主键</param>\r\n");
                sb.Append("        void DeleteEntity(" + baseInfo.pkType + " keyValue);\r\n");
        ...
        public string GridEditIBllCreate(BaseModel baseInfo, string dbTable, ColModel colData)
        {
            try
            {
                ...
                sb.Append("        /// <param name=\"keyValue\">主键</param>\r\n");
                sb.Append("        /// <param name=\"entity\">实体</param>\r\n");
                sb.Append("        void SaveEntity(" + baseInfo.pkType + " keyValue, " + dbTable + "Entity entity);\r\n");
        ...
        private string GetWfEntityCode(List<TreeModelEx<DbTableModel>> TableTree, List<DbTableModel> girdDbTableList, BaseModel baseInfo, string tableName)
        {
            ...
            foreach (var tableOne in TableTree)
            {
                ...
                {
                    res += "            IEnumerable<" + tableOne.data.name + "Entity> " + tableOne.data.name + "Data = null ;\r\n";//修复我的任务发起流程异常Bug
                    res += "             if(" + tableOne.data.relationName + "Data != null)\r\n";
                    res += "                {\r\n";
                    res += "                    " + tableOne.data.name + "Data = " + Str.FirstLower(baseInfo.name) + "IBLL.Get" + tableOne.data.name + "List( " + keyvalue + " );\r\n";
                    res += "                 }\r\n";
                }
                else
                {
                    res += "            " + tableOne.data.name + "Entity " + tableOne.data.name + "Data = null ;\r\n";//修复我的任务发起流程异常Bug
                    res += "             if(" + tableOne.data.relationName + "Data != null)";
                    res += "               {\r\n";
                    res += "                      " + tableOne.data.name + "Data = " + Str.FirstLower(baseInfo.name) + "IBLL.Get" + tableOne.data.name + "Entity( " + keyvalue + " );\r\n";
                    res += "                 }\r\n";
                }
        ...
        public string ControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("        [HttpPost]\r\n");
                sb.Append("        [AjaxOnly]\r\n");
                sb.Append("        public ActionResult DeleteForm(" + baseInfo.pkType + " keyValue)\r\n");
                sb.Append("        {\r\n");
                ...
                sb.Append("        /// </summary>\r\n");
                sb.Append("        /// <param name=\"keyValue\">主键</param>\r\n");
                sb.Append("        /// <param name=\"strEntity\">实体</param>\r\n");
                sb.Append("        /// <returns></returns>\r\n");
                sb.Append("        [HttpPost]\r\n");
                sb.Append("        [ValidateAntiForgeryToken]\r\n");
                sb.Append("        [AjaxOnly]\r\n");
                ...
                // 函数传入参数
                string paramStr = baseInfo.pkType + " keyValue, string strEntity,";
                string paramStr2 = "keyValue,entity,";
                ...
                {
                    sb.Append("            if (keyValue != null)\r\n");
                }
                sb.Append("            {\r\n");
                foreach (var key in compontMap.Keys)
                {
                    if (compontMap[key].type == "encode")
                    {
                        sb.Append("                CodeRuleIBLL codeRuleIBLL = new CodeRuleBLL();\r\n");
                        sb.Append("                codeRuleIBLL.UseRuleSeed(\"" + compontMap[key].rulecode + "\");\r\n");
                    }
                }
                sb.Append("            }\r\n");
        ...
        public string WfControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("using " + backProject + getBackArea(baseInfo.outputArea) + ";\r\n");
                sb.Append("using System.Web.Mvc;\r\n");
                sb.Append("using Learun.Application.TwoDevelopment.LR_CodeDemo;\r\n");
                sb.Append("using System.Collections.Generic;\r\n\r\n");
                ...
                sb.Append("    {\r\n");
                sb.Append("        private " + baseInfo.name + "IBLL " + Str.FirstLower(baseInfo.name) + "IBLL = new " + baseInfo.name + "BLL();\r\n");
                sb.Append("        private CodeRuleIBLL codeRuleIBLL = new CodeRuleBLL();\r\n\r\n");
                sb.Append("        #region 视图功能\r\n\r\n");
                ...
                sb.Append("        /// 获取表单数据\r\n");
                sb.Append("        /// </summary>\r\n");
                sb.Append("        /// <param name=\"processId\">流程实例主键</param>\r\n");
                sb.Append("        /// <returns></returns>\r\n");
                sb.Append("        [HttpGet]\r\n");
                sb.Append("        [AjaxOnly]\r\n");
        ...
        public string GridEditControllerCreate(BaseModel baseInfo, string dbTable, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("        [ValidateAntiForgeryToken]\r\n");
                sb.Append("        [AjaxOnly]\r\n");
                sb.Append("        public ActionResult SaveForm(" + baseInfo.pkType + " keyValue, " + dbTable + "Entity entity)\r\n");
                sb.Append("        {\r\n");
        ...
        public string WfIndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                sb.Append("                  level:'1',\r\n");
                sb.Append("             };\r\n");
                sb.Append("             learun.httpAsync('Post', top.$.rootUrl + '/LR_NewWorkFlow/NWFProcess/CreateFlow', postData, function(data) {\r\n");
                sb.Append("                 learun.loading(false);\r\n");
                sb.Append("             });\r\n");
        ...
        /// <param name="compontMap">主键映射信息</param>
        /// <returns></returns>
        ...
        public string FormJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap)
        {
            try
            {
                ...
                sb.Append("            }\r\n");
                //设置默认值
                foreach (var item in compontMap)
                {
                    if (item.Value.type == "text" && !string.IsNullOrEmpty(item.Value.dfvalue))
                    {
                        sb.Append(string.Format("           $('#{0}').val('{1}');\r\n", item.Value.field, item.Value.dfvalue));
                    }
                }
                sb.Append("        }\r\n");
                sb.Append("    };\r\n");
        ...
        public string WfFormJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap, string workField)
        {
            try
            {
                ...
                sb.Append("    // 设置表单数据\r\n");
                sb.Append("    setFormData = function (processId,param,callback) {\r\n");
                ...
                sb.Append("                        if(id == '" + mainTable + "' && data[id] ){\r\n");
        ...
        public void CreateAppIndexCodeFile(BaseModel baseInfo, string codeContent, string type)
        {
            try
            {
                DirFileHelper.CreateFileContent(baseInfo.appDirectory + "\\pages\\" + baseInfo.outputArea + "\\" + baseInfo.name + "\\" + baseInfo.name + "." + type, codeContent);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateAppFormCodeFile(BaseModel baseInfo, string codeContent, string type)
        {
            try
            {
                DirFileHelper.CreateFileContent(baseInfo.appDirectory + "\\pages\\" + baseInfo.outputArea + "\\" + baseInfo.name + "\\form\\form." + type, codeContent);
            }
            catch (Exception)
            {
                throw;
        ...
        /// <param name="codeContent"></param>
        /// <param name="type"></param>
        public void CreateWxIndexCodeFile(BaseModel baseInfo, string codeContent, string type)
        {
            try
            {
                DirFileHelper.CreateFileContent(baseInfo.appDirectory + "\\pages\\" + baseInfo.outputArea + "\\" + baseInfo.name + "\\list." + type, codeContent);
            }
            catch (Exception)
            {
                throw;
        ...
        /// <param name="codeContent"></param>
        /// <param name="type"></param>
        public void CreateWxFormCodeFile(BaseModel baseInfo, string codeContent, string type)
        {
            try
            {
                DirFileHelper.CreateFileContent(baseInfo.appDirectory + "\\pages\\" + baseInfo.outputArea + "\\" + baseInfo.name + "\\single." + type, codeContent);
            }
            catch (Exception)
            {
                throw;
