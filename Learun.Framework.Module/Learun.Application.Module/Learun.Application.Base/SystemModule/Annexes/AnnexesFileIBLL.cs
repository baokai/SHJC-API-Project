...
namespace Learun.Application.Base.SystemModule
{
    ...
    public interface AnnexesFileIBLL
    {
        ...
        /// <param name="keyValue">主键</param>
        /// <returns></returns>
        SharefilelistEntity GetSharefilelistEntity(int keyValue);
        /// <summary>
        /// 获取Sharefilelist数据
        /// </summary>
        ...
        /// <returns></returns>
        IEnumerable<SharefilelistVo> GetSharefilelistPageList(Pagination pagination, string queryJson);
        #endregion
        ...
        void SaveSharefilelist(SharefilelistEntity entity);
        /// <summary>
        /// 删除附件
        /// </summary>
        ...
        void DeleteSharefilelist(int Id);
        #endregion
