...
namespace Learun.Application.Base.SystemModule
{
    ...
    public class AnnexesFileBLL : AnnexesFileIBLL
    {
        ...
        public SharefilelistEntity GetSharefilelistEntity(int keyValue)
        {
            try
            {
                return annexesFileService.GetSharefilelistEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<SharefilelistVo> GetSharefilelistPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return annexesFileService.GetSharefilelistPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveSharefilelist(SharefilelistEntity entity)
        {
            try
            {
                annexesFileService.SaveSharefilelist(entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteSharefilelist(int Id)
        {
            try
            {
                annexesFileService.DeleteSharefilelist(Id);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
