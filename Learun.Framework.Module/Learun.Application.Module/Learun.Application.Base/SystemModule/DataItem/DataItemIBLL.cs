...
namespace Learun.Application.Base.SystemModule
{
    ...
    public interface DataItemIBLL
    {
        ...
        /// <returns></returns>
        DataItemDetailEntity GetDetailItemName(string itemValue, string itemCode);
        DataItemDetailEntity GetDetailItemName1(string itemValue, string itemCode);
        /// <summary>
        /// 获取数据字典明显
        /// </summary>
        /// <param name="itemCode">分类编码</param>
        ...
        List<TreeModel> GetDetailTreeHZ(string itemCode);
        /// <summary>
        /// 项目值不能重复
        /// </summary>
        /// <param name="keyValue">主键</param>
