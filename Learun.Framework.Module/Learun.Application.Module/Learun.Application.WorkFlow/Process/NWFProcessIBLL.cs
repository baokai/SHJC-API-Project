...
namespace Learun.Application.WorkFlow
{
    ...
    public interface NWFProcessIBLL
    {
        ...
        void GetEntityByWorkFlowId(string keyValue, NWFProcessEntity entity);
        #endregion
        ...
        /// <param name="processId">流程进程主键</param>
        /// <param name="userInfo">当前操作人信息</param>
        void AgainCreateFlow(string processId, UserInfo userInfo, string des);
        /// <summary>
        /// 审批流程
        /// </summary>
        ...
        void AuditFlowstest(string operationCode, string taskIds, UserInfo userInfo);
        /// <summary>
        /// 流程加签
        /// </summary>
        /// <param name="processId">流程进程主键</param>
        ...
        /// <param name="processId">流程进程主键</param>
        /// <param name="userInfo">当前操作人信息</param>
        int? BoolRevokeFlow(string processId, UserInfo userInfo);
        /// <summary>
        ...
        /// <returns></returns>
       //NWFProcessEntity GetTitle(string processId);
        /// <summary>
        /// 获取流程当前任务需要处理的人
        /// </summary>
        /// <param name="processId">流程进程主键</param>
        ...
        IEnumerable<NWFTaskEntity> GetTaskUserList_NodbWhere(string processId);
        ...
        /// <returns></returns>
       IEnumerable<CommentsVo> GetCommentsList(string WorkFlowId);
        IEnumerable<CommentsEntity> GetCommentsListById(string WorkFlowId, string id);
        /// <summary>
        /// 根据节点查询对应数据
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        List<CommentsEntity> GetCommentsListByIdNode(string id);
        void deleteTaskList(IEnumerable<NWFTaskEntity> taskList, string processId);
        #endregion
