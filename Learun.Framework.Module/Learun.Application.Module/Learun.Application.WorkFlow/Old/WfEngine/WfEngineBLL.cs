...
namespace Learun.Application.WorkFlow
{
    ...
    public class WfEngineBLL : WfEngineIBLL
    {
        ...
        /// 审核流程节点
        /// </summary>
        /// <param name="parameter">流程参数verifyType：1.审核同意2.审核不同意3.转交4.转交-同意5.转交-不同意6.确认阅读7.保存草稿</param>
        /// <returns></returns>
            ...
            try
            {
                ...
                else if (currentTask.F_IsFinished == 1)
                {
                    ...
                    else
                    {
                        ...
                        List<WfTaskEntity> wfReadTaskList = new List<WfTaskEntity>();
                        bool res = true;
                        switch (parameter.verifyType)//1.审核同意2.审核不同意3.转交4.转交-同意5.转交-不同意6.确认阅读7.保存草稿(暂时不做处理)
                        {
                            case "1":
                            ...
                            case "3":
                                ...
                                CreateTaskHistory(parameter, currentNode, currentTask, 1, parameter.description);
                                wfResult.desc = "流程转交成功";
                                break;
                            case "4":
                                res = GetNextTaskes(currentNode, WfTransportType.Agree, wfTaskList, wfReadTaskList, parameter);
                                parameter.description = "【转交】" + parameter.description;
