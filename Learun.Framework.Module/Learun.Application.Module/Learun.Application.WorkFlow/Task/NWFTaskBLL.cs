...
namespace Learun.Application.WorkFlow
{
    ...
    public class NWFTaskBLL : NWFTaskIBLL
    {
        ...
        {
            nWFTaskSerivce.CommentsSave(WorkFlowId, id, CommentsName);
        } 
        /// <summary>
        /// 修改评论
        /// </summary>
        ...
        {
            nWFTaskSerivce.CommentsUpdate(id,strEntity);
        }
        /// <summary>
        /// 获取任务执行日志实体
        /// </summary>
        ...
        {
            return nWFTaskSerivce.GetEntityChildProcessId(processId);
        }
        /// <summary>
        /// 获取任务执行人列表
        /// </summary>
        ...
        {
            return nWFTaskSerivce.GetTaskUserList_NodbWhere(taskId);
        }
        public NWFTaskEntity GetEntityForProcessId(string processid)
        {
            return nWFTaskSerivce.GetEntityForProcessId(processid);
        } 
        public NWFTaskEntity GetEntityF_PrevNodeIdbyProcessId(string processid, string prevNodeId)
        {
            return nWFTaskSerivce.GetEntityF_PrevNodeIdbyProcessId(processid, prevNodeId);
        }
        #endregion
